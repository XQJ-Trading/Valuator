...
class AIAgentDemo:
    ...
    async def run_predefined_examples(self):
        ...
        examples = [
            ...
            },
            {
                ...
                "query": "Research the benefits of renewable energy and create a summary with key points",
                "description": "Tests information gathering and synthesis"
            },
            {
    ...
    async def _solve_with_react(self, query: str, show_progress: bool = True):
        ...
        print(f"🛠️  Tools used: {len(set(s.tool_name for s in state.steps if s.tool_name))}")
...
async def main():
    ...
    while True:
        ...
        if choice.lower() in ['quit', 'exit', 'q']:
            ...
            capability = input("Enter capability (reasoning/calculation/research/coding/analysis): ").strip()
