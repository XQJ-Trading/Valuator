        ...
        **kwargs
        ...
        try:
            ...
            generation = Generation(
                ...
                message=ai_message,
                generation_info={
                    'finish_reason': ai_message.response_metadata.get('finish_reason') if hasattr(ai_message, 'response_metadata') else None,
                    'safety_ratings': ai_message.response_metadata.get('safety_ratings') if hasattr(ai_message, 'response_metadata') else None,
                }
            )
